...
export default function Home() {
  return (
    <section data-aos="fade-up" className="absolute z-5 top-0 left-0 size-full">
      <div data-aos="fade-up" className=" container m-auto z-5 size-full items-start justify-end flex-col pb-20 hidden md:flex">
        <p className={`w-150 text-lg font-bold leading-[1.2] text-white ${abrilFatface.className}`}>
            ...
            The company focuses on supplying high-quality electrical appliances, automotive products and accessories, 
      ...
      <div data-aos="fade-up" className=" container m-auto z-5 size-full md:hidden flex items-start justify-end flex-col px-10 pb-20">
