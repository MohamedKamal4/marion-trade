    ...
    return(
        <>
            <div className="hidden lg:flex size-full">
                <div data-aos='fade-right' className="w-1/2 h-full">
            ...
            {/* tablits */}
            <div className="lg:hidden md:flex hidden size-full py-10 ">
            ...
            <div className="md:hidden size-full">
                <div data-aos='zoom-in' className=" flex flex-col justify-center gap-5 lg:h-100 size-full">
                                ...
                                return(
                                    <CarouselItem key={i}>
                                        <div className="size-full flex flex-col justify-center items-center">
                                            ...
                                            <p className="text-center px-10 text-sm">{item.description}</p>
                                        </div>
                                    </CarouselItem>
                                )
                            })}
                    ...
                    <h3 className="text-xs w-full p-5">{brandsContent[keyOfContent].mainTitle}</h3>
                </div>
            </div>
        </>
    )
